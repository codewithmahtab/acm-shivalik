...
const domains = [
  ...
  },
  {
    ...
    tagStyle: "group-hover:border-emerald-500/20 group-hover:text-emerald-400/60",
  },
  {
    id: "05",
    icon: FlaskConical,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 lg:px-24">
        ...
        {/* ── Domain Grid: 3 top + 2 bottom centered ── */}
  ...
  return (
    <div
      className={`domain-card group relative border rounded-sm p-7 cursor-default
                  ...
                  ${isActive ? "border-white/10 bg-white/[0.04]" : "border-white/5 bg-white/[0.01]"}
                  ${domain.border}`}
    ...
    >
      {/* Gradient wash */}
      <div
        className={`absolute inset-0 bg-gradient-to-br ${domain.glow} opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
      />
      ...
      {/* Icon */}
      <div className={`relative z-10 mb-5 w-10 h-10 flex items-center justify-center border rounded-sm transition-all duration-300 ${domain.iconBg}`}>
