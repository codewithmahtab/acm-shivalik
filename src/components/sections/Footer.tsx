      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-16">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-12">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-blue-500 font-bold text-xl tracking-tight">ACM</span>
              <span className="text-white font-light text-xl tracking-widest uppercase">Shivalik</span>
            </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li className="text-gray-500 text-sm">Shivalik College of Engineering</li>
        ...
        <div className="mt-16 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-700 text-xs tracking-wide">
            &copy; {new Date().getFullYear()} ACM Student Chapter — Shivalik College of Engineering. All rights reserved.
          </p>
          <p className="text-gray-700 text-xs tracking-wide">
