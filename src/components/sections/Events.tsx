  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[500px] bg-blue-600/5 rounded-full blur-[160px]" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-blue-900/5 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div
          ref={cardRef}
          style={{ opacity: 0 }}
          className="group relative border border-white/5 hover:border-blue-500/30 bg-white/[0.01] hover:bg-white/[0.03] rounded-sm overflow-hidden transition-all duration-500"
        >
          {/* Gradient wash */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/8 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-0">
            ...
            <div className="lg:w-64 xl:w-72 p-8 md:p-10 flex flex-col justify-center gap-6">
              ...
              {event.highlights.map((h) => (
                <div key={h.label} className="flex flex-col gap-1 border-b border-white/5 pb-5 last:border-none last:pb-0">
