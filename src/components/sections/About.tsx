  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 lg:px-24">
        ...
        {/* ── Two-column: text left, accent right ── */}
        <div
          ref={textRef}
          style={{ opacity: 0 }}
        ...
        >
          ...
          <div className="space-y-5">
            <p className="text-gray-400 text-base md:text-lg leading-relaxed">
              <span className="text-white font-medium">ACM Chapter Shivalik</span> is
            ...
            <p className="text-gray-500 text-sm md:text-base leading-relaxed">
              ...
              building projects that matter, competing at national platforms, and
              learning from each other. From first-year coders to final-year
          ...
          {/* Right: ACM quote / identity block */}
          <div className="flex flex-col gap-4">
            ...
            <div className="border border-white/5 bg-white/[0.02] p-6 rounded-sm">
              ...
              <p className="text-white text-2xl font-bold tracking-tight">2023</p>
        ...
        >
          {pillars.map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="pillar-card group border border-white/5 bg-white/[0.02] hover:bg-white/[0.04] hover:border-blue-500/20 p-6 rounded-sm transition-all duration-300 cursor-default"
            >
